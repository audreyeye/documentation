...
1. Install the WinUSB driver. (If you have installed it, skip this step.)
   ...
   2. Do not power off the device. Re-enter the flash mode and follow the instructions below to install Microsoft WinUSB.

     * In Device Manager, find the RUBIK Pi 3 device with a warning icon next to it and select **Update driver.**
